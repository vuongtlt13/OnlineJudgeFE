...
function getProblemPoint(acCount, totalScore) {
  let point = acCount === 0 ? totalScore : (totalScore / acCount).toFixed(2);
  return String(point);
}
...
function rankSort(a, b) {
  ...
  if (acRateOfA < acRateOfB) return 1;
  if (acRateOfA > acRateOfB) return -1;
  return 0;
}
...
export default {
  ...
  getProblemPoint: getProblemPoint,
  rankSort: rankSort
};
